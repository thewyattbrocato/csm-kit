...
- **Frontline demo hierarchy is intentional.** Keep the interactive README invitation directly below the workflow image and before `Real output`; keep the generated account readout primary in the demo, with source editors available through progressive disclosure.
